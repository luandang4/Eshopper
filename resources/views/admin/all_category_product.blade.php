                ...
                <tr>
                    ...
                    <td><span class="text-ellipsis">
                        ...
                        if($cate_pro -> category_status == 0){
                            ?> 
                            <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"><span class="fa-thum-style fa fa-toggle-off" style="font-size:20px;"></span></a>
                            <?php
                        }else{
                            ?>
                            <a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"><span class="fa-thum-style fa fa-toggle-on" style="font-size:20px;"></span></a>
                            <?php
                        }
                        ?>
                    </span></td>
